...
var AllPoses = []Pose{
...

	{
		...
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Place your fingertips on your cheek with gentle pressure. Now move your hand in small, slow circular motions — like massaging the cheek muscle. Keep continuous contact with the skin throughout the circle. One full circle (about 270 degrees) counts as one rep. This stimulates lymphatic drainage and cheek circulation. Use either hand. Repeat 5 times.",
		InstructionsTR:    "Parmak uçlarınızı yanağınıza hafif baskıyla koyun. Şimdi elinizi küçük, yavaş dairesel hareketlerle hareket ettirin — yanak kasını masaj yapıyormuşsunuz gibi. Daire boyunca cilt ile sürekli temas halinde olun. Bir tam daire (yaklaşık 270 derece) bir tekrar sayılır. Bu, lenfatik drenajı ve yanak kanlanmasını uyarır. Her iki elinizi kullanabilirsiniz. 5 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
	...
	},
	{
		...
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Place your fingertips at the center of your forehead with light pressure. Now sweep your hand outward toward your temple in one smooth stroke — like ironing out a wrinkle. Keep skin contact throughout the sweep. Moving your hand far enough to the side (about 10% of your face width) counts as one rep. This smooths the frontalis muscle and reduces forehead tension lines. Use either hand. Repeat 5 times.",
		InstructionsTR:    "Parmak uçlarınızı alnınızın ortasına hafif baskıyla koyun. Şimdi elinizi bir kırışığı ütülüyormuşsunuz gibi şakağınıza doğru düzgün bir hareketle kaydırın. Hareket boyunca cilt ile temas halinde olun. Elinizi yeterince yana hareket ettirmek (yaklaşık yüz genişliğinin %10'u) bir tekrar sayılır. Bu, frontalis kasını düzleştirir ve alın gerginlik hatlarını azaltır. Her iki elinizi kullanabilirsiniz. 5 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face_hand",
...

	{
		...
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Place 2–3 fingertips on one temple — the flat area between your eye and ear. Apply moderate pressure and make slow, continuous circular motions. Keep your fingers moving in circles without lifting them. One full circle (about 270 degrees) counts as one rep. This relieves temporal headaches and tension from prolonged screen time or stress. Breathe slowly throughout. Use either hand. Repeat 5 times.",
		InstructionsTR:    "2–3 parmak ucunuzu bir şakağınıza — göz ile kulak arasındaki düz alana — koyun. Orta düzeyde baskı uygulayın ve yavaş, sürekli dairesel hareketler yapın. Parmaklarınızı kaldırmadan daire çizmeye devam edin. Bir tam daire (yaklaşık 270 derece) bir tekrar sayılır. Bu, uzun süreli ekran kullanımı veya stresin neden olduğu temporal baş ağrılarını ve gerginliği giderir. Boyunca yavaşça nefes alın. Her iki elinizi kullanabilirsiniz. 5 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face_hand",
...

	{
		...
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Place your fingertips between your eyebrows with light pressure. Now sweep your fingers outward toward one temple in a single smooth stroke. Keep skin contact throughout. Moving far enough sideways (about 10% of your face width) counts as one rep. This smooths the corrugator muscles that cause frown lines and relieves tension between the brows. Use either hand and alternate sides. Repeat 5 times.",
		InstructionsTR:    "Parmak uçlarınızı kaşlarınızın arasına hafif baskıyla koyun. Şimdi parmaklarınızı tek bir düzgün hareketle bir şakağınıza doğru kaydırın. Hareket boyunca cilt ile temas halinde olun. Yeterince yana hareket ettirmek (yaklaşık yüz genişliğinin %10'u) bir tekrar sayılır. Bu, kaş çatma çizgilerine neden olan corrugator kaslarını düzleştirir ve kaşlar arasındaki gerginliği giderir. Her iki elinizi kullanın ve tarafları değiştirin. 5 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face_hand",
...

	{
		...
		NameEN:            "Jawline Sculpt",
		NameTR:            "Jawline Şekillendirme",
		Category:          CategoryFace,
		Difficulty:        2,
		TargetArea:        "face",
		InstructionsEN:    "Make a gentle fist or use your knuckles and place them under your chin at the center. Now sweep your hand outward along your jawline toward your ear in a firm, continuous stroke — like sculpting the jaw edge. Keep pressure on the skin throughout. Moving far enough sideways (about 12% of your face width) counts as one rep. This drains lymph along the jaw, tones the masseter muscle, and defines the jawline. Use either hand. Repeat 8 times.",
		InstructionsTR:    "Hafif bir yumruk yapın ya da eklemlerinizi kullanın ve çenenizin altına merkeze koyun. Şimdi elinizi çene kenarınızı heykeltraş gibi şekillendiriyormuşsunuz gibi güçlü, kesintisiz bir hareketle kulağınıza doğru kaydırın. Hareket boyunca deri üzerindeki baskıyı koruyun. Yeterince yana hareket ettirmek (yaklaşık yüz genişliğinin %12'si) bir tekrar sayılır. Bu, çene boyunca lenfatik drenajı sağlar, masseter kasını tonlar ve jawline'ı belirginleştirir. Her iki elinizi kullanabilirsiniz. 8 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face_hand",
