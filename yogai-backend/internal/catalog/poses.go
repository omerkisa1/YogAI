...
var AllPoses = []Pose{
	...
	{
		PoseID:            "face_fish_lips",
		NameEN:            "Fish Lips",
		NameTR:            "Balık Dudağı",
		Category:          CategoryFace,
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Suck in your cheeks and push your lips forward like a fish. Hold, then relax. Repeat.",
		InstructionsTR:    "Yanaklarınızı içeri çekin ve dudaklarınızı balık gibi öne itin. Tutun, sonra gevşetin. Tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face",
...

	{
		...
		NameEN:            "Cheek Massage",
		NameTR:            "Yanak Masajı",
		Category:          CategoryFace,
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Place your fingertips on your cheek. Gently press and hold for 2 seconds, then release. Repeat.",
		InstructionsTR:    "Parmak uçlarınızı yanağınıza koyun. Hafifçe bastırın ve 2 saniye tutun, sonra bırakın. Tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
	...
	},
	{
		...
		NameEN:            "Forehead Smoothing",
		NameTR:            "Alın Düzleştirme",
		Category:          CategoryFace,
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Place your palm on your forehead. Apply gentle pressure and hold for 3 seconds, then release. Repeat.",
		InstructionsTR:    "Avucunuzu alnınıza koyun. Hafifçe bastırın ve 3 saniye tutun, sonra bırakın. Tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face_hand",
	...
	},
	{
		...
		NameEN:            "Jaw Release with Hand",
		NameTR:            "Elle Çene Gevşetme",
		Category:          CategoryFace,
		Difficulty:        2,
		TargetArea:        "face",
		InstructionsEN:    "Place your hand under your chin. Open your mouth while gently pressing up with your hand. Hold 2.5 seconds, then close. Repeat.",
		InstructionsTR:    "Elinizi çenenizin altına koyun. Elinizle hafifçe yukarı bastırırken ağzınızı açın. 2.5 saniye tutun, sonra kapatın. Tekrarlayın.",
	...
	{
		PoseID:            "face_cheek_puff",
		NameEN:            "Cheek Puff",
		NameTR:            "Yanak Şişirme",
		Category:          CategoryFace,
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Take a deep breath and close your lips. Blow air into both cheeks, puffing them out as much as possible. Keep your lips firmly sealed. Hold for 2 seconds, then slowly release the air through your lips. This strengthens the cheek muscles and improves facial circulation. Repeat 10 times.",
		InstructionsTR:    "Derin bir nefes alın ve dudaklarınızı kapatın. Havayı her iki yanağınıza üfleyin, onları mümkün olduğunca şişirin. Dudaklarınızı sıkıca kapalı tutun. 2 saniye tutun, ardından havayı yavaşça dudaklarınızdan bırakın. Bu hareket yanak kaslarını güçlendirir ve yüz kanlanmasını iyileştirir. 10 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face",
...

	{
		...
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Sit up straight and look straight ahead. Open both eyes as wide as you can, as if you are surprised or startled. You should feel a stretch around the eyebrows and forehead. Hold this wide-eyed position for 2 seconds, then slowly relax your eyes back to normal. This tones the muscles around the eyes and reduces drooping eyelids. Repeat 10 times.",
		InstructionsTR:    "Dik oturun ve düz ileriye bakın. Her iki gözünüzü olabildiğince geniş açın, şaşırmış ya da irkilmiş gibi. Kaşlar ve alın çevresinde bir germe hissetmelisiniz. Bu geniş gözlü pozisyonu 2 saniye tutun, ardından gözlerinizi yavaşça normale döndürün. Bu hareket göz çevresi kaslarını tonlar ve sarkık göz kapaklarını azaltır. 10 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face",
	...
	{
		PoseID:            "face_eye_blink",
		NameEN:            "Deliberate Eye Blink",
		NameTR:            "Kasıtlı Göz Kırpma",
		Category:          CategoryFace,
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Unlike a quick blink, this is a slow, deliberate exercise. Look straight into the camera. Slowly close both eyes completely over about 1 second, as if lowering a curtain — feel the upper eyelids moving down fully. Hold your eyes tightly shut for 1 second, then slowly open them. Do not squeeze hard; the movement should be gentle and controlled. This strengthens the eyelid muscles and reduces puffiness. Repeat 15 times.",
		InstructionsTR:    "Hızlı bir göz kırpmadan farklı olarak, bu yavaş ve kasıtlı bir egzersizdir. Kameraya düz bakın. Her iki gözünüzü yaklaşık 1 saniye içinde yavaşça tamamen kapatın, sanki bir perde indiriyormuşsunuz gibi — üst göz kapaklarının tamamen kapandığını hissedin. Gözlerinizi 1 saniye sıkıca kapalı tutun, ardından yavaşça açın. Sıkıca sıkmayın; hareket nazik ve kontrollü olmalıdır. Bu, göz kapağı kaslarını güçlendirir ve şişliği azaltır. 15 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face",
...

	{
		...
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Relax your face, then actively pull the corners of your mouth downward and outward — as if you are deeply unhappy or sulking. Keep your lips together; do not open your mouth. You should feel tension along the sides of your chin and jaw. Hold this frown for 2 seconds, then return to neutral. This targets the depressor anguli oris muscle and tones the lower face. Repeat 10 times.",
		InstructionsTR:    "Yüzünüzü gevşetin, ardından ağzınızın köşelerini aktif olarak aşağıya ve dışa doğru çekin — derinden mutsuzmuşsunuz ya da somurtuyormuşsunuz gibi. Dudaklarınızı kapalı tutun; ağzınızı açmayın. Çenenizin ve çene kenarlarının boyunca gerilme hissedeceksiniz. Bu somurma ifadesini 2 saniye tutun, ardından normale dönün. Bu hareket çene köşesi kasını hedefler ve alt yüzü tonlar. 10 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face",
...

	{
		...
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Keeping your mouth relaxed and closed, scrunch your nose upward as if you smell something very bad. Wrinkle the skin on the bridge of your nose and pull your upper lip very slightly upward. You should feel the muscles on both sides of your nose activating. Hold for 2 seconds, then completely release and relax. This tones the nasalis muscle and the muscles around the nose. Repeat 10 times.",
		InstructionsTR:    "Ağzınızı rahat ve kapalı tutarken, çok kötü bir koku alıyormuşsunuz gibi burnunuzu yukarı kıvırın. Burun köprüsündeki deriyi buruşturun ve üst dudağınızı çok hafifçe yukarı çekin. Burnunuzun her iki yanındaki kasların aktive olduğunu hissedeceksiniz. 2 saniye tutun, ardından tamamen bırakın ve gevşeyin. Bu hareket burun kaslarını ve burun çevresindeki kasları tonlar. 10 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face",
	...
	{
		PoseID:            "face_brow_outer_raise",
		NameEN:            "Outer Brow Raise",
		NameTR:            "Dış Kaş Kaldırma",
		Category:          CategoryFace,
		Difficulty:        2,
		TargetArea:        "face",
		InstructionsEN:    "This is an advanced exercise requiring isolated muscle control. Look straight ahead. Try to lift only the outer tails of your eyebrows (the ends nearest your temples) upward, while keeping the inner ends near the bridge of your nose relatively still. Imagine the outer corners of your brows lifting like wings. You may need to practice several times before feeling the isolation. Hold 2 seconds, relax. This targets the lateral frontalis muscle. Repeat 10 times.",
		InstructionsTR:    "Bu, izole kas kontrolü gerektiren ileri düzey bir egzersizdir. Düz ileriye bakın. Yalnızca kaşlarınızın dış uçlarını (şakaklarınıza en yakın kısımları) yukarı kaldırmaya çalışın, burun köprüsüne yakın iç uçları ise nispeten sabit tutun. Kaşlarınızın dış köşelerinin kanat gibi yükseldiğini hayal edin. İzolasyonu hissedebilmek için birkaç kez pratik yapmanız gerekebilir. 2 saniye tutun, gevşeyin. Bu hareket lateral frontalis kasını hedefler. 10 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face",
...

	{
		...
		NameEN:            "Mouth Stretch",
		NameTR:            "Ağız Germe",
		Category:          CategoryFace,
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Keep your teeth lightly together and stretch the corners of your mouth outward to the sides as far as you can — like saying a very wide 'EEEE'. Do not open your mouth vertically; focus on the horizontal stretch. You should feel a strong pull along the sides of your mouth and cheeks. Hold for 2 seconds, then slowly return to neutral. This tones the risorius and zygomaticus muscles. Repeat 10 times.",
		InstructionsTR:    "Dişlerinizi hafifçe birleştirin ve ağzınızın köşelerini yanlara doğru olabildiğince gerin — çok geniş bir 'EEEEE' diyormuşsunuz gibi. Ağzınızı dikey olarak açmayın; yatay germmeye odaklanın. Ağzınızın yanları ve yanaklar boyunca güçlü bir çekme hissedeceksiniz. 2 saniye tutun, ardından yavaşça normale dönün. Bu hareket risorius ve zygomaticus kaslarını tonlar. 10 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face",
	...
	{
		PoseID:            "face_lip_roll",
		NameEN:            "Lip Roll",
		NameTR:            "Dudak Yuvarlama",
		Category:          CategoryFace,
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "With your mouth gently closed, roll both your upper and lower lips inward so they disappear over your teeth — like hiding your lips inside your mouth. Press them firmly together without opening your jaw. You should feel your lip muscles and the area around your mouth working. Hold for 2 seconds, then release and let your lips return naturally. This strengthens the orbicularis oris muscle that encircles the mouth. Repeat 10 times.",
		InstructionsTR:    "Ağzınızı hafifçe kapalı tutarken, hem üst hem de alt dudağınızı içeri yuvarlayın, dişlerinizin üzerine gelsinler — dudaklarınızı ağzınızın içinde gizliyormuşsunuz gibi. Çenenizi açmadan onları birbirine sıkıca bastırın. Dudak kaslarınızın ve ağız çevresindeki bölgenin çalıştığını hissedeceksiniz. 2 saniye tutun, ardından bırakın ve dudaklarınızın doğal olarak dönmesine izin verin. Bu hareket ağzı çevreleyen orbicularis oris kasını güçlendirir. 10 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face",
...

	{
		...
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Relax your face and gently close your mouth. Now curl your upper lip upward and outward — like a slight snarl — to expose your upper teeth and gums slightly. Keep your lower lip still. You should feel the muscles just above your upper lip and under your nose activating. Hold for 2 seconds, then relax and let the lip return. This targets the levator labii superioris and helps lift the mid-face area. Repeat 10 times.",
		InstructionsTR:    "Yüzünüzü gevşetin ve ağzınızı hafifçe kapatın. Şimdi üst dudağınızı hafifçe bürerek yukarıya ve dışarıya doğru kıvırın — hafif bir homurdanma gibi — üst dişlerinizi ve diş etinizin birazını gösterin. Alt dudağınızı sabit tutun. Üst dudağınızın hemen üstündeki ve burnnuzun altındaki kasların aktive olduğunu hissedeceksiniz. 2 saniye tutun, ardından gevşetin ve dudağın dönmesine izin verin. Bu hareket levator labii superioris'i hedefler ve orta yüz bölgesinin kaldırılmasına yardımcı olur. 10 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face",
...

	{
		...
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Using your index and middle fingers, gently place your fingertips just below and around your eye socket — along the orbital bone. Do NOT press directly on the eyeball. Apply very light, steady pressure for 2 seconds, then slowly lift your fingers. This helps reduce puffiness and stimulates lymphatic drainage around the eyes. Use minimal pressure — this should feel soothing, not painful. Repeat 5 times.",
		InstructionsTR:    "İşaret ve orta parmağınızı kullanarak parmak uçlarınızı göz çukurunuzun hemen altına ve çevresine — orbital kemik boyunca — nazikçe koyun. Doğrudan göz küresine BASMAYIN. 2 saniye boyunca çok hafif, sabit bir baskı uygulayın, ardından parmaklarınızı yavaşça kaldırın. Bu, göz çevresindeki şişliği azaltmaya ve lenf drenajını uyarmaya yardımcı olur. Minimum baskı kullanın — bu, ağrılı değil, sakinleştirici hissettirmelidir. 5 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face_hand",
...

	{
		...
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Place 2–3 fingertips of both hands firmly against your temples — the flat area between your eye and ear. Apply moderate circular pressure while slowly making small circles. After 2–3 circles, hold the pressure still for 2.5 seconds, then gently release. This relieves temporal headaches and tension caused by prolonged screen time or stress. Breathe slowly throughout. Repeat 5 times.",
		InstructionsTR:    "Her iki elinizin 2–3 parmak ucunu şakaklarınıza — göz ile kulak arasındaki düz alana — sıkıca yerleştirin. Yavaşça küçük daireler çizerken orta düzeyde dairesel baskı uygulayın. 2–3 daireden sonra baskıyı sabit tutun ve 2.5 saniye bekleyin, ardından nazikçe bırakın. Bu, uzun süreli ekran kullanımı veya stresin neden olduğu temporal baş ağrılarını ve gerginliği giderir. Boyunca yavaşça nefes alın. 5 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face_hand",
...

	{
		...
		NameEN:            "Nose Bridge Press",
		NameTR:            "Burun Kemiği Baskısı",
		Category:          CategoryFace,
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Using your index and middle fingers together, place them side by side on the bridge of your nose — just below the point between your eyebrows. Apply a gentle downward and inward pressure for 2 seconds. This stimulates the acupressure point that can relieve sinus pressure and frontal headaches. Keep your breathing steady. Then slowly lift your fingers. Repeat 5 times.",
		InstructionsTR:    "İşaret ve orta parmağınızı bir arada kullanarak kaşlarınızın arasındaki noktanın hemen altına — burun kemiğinin üzerine — yan yana yerleştirin. 2 saniye boyunca hafif bir aşağı ve içe doğru baskı uygulayın. Bu, sinüs baskısını ve frontal baş ağrılarını giderebilecek akupresür noktasını uyarır. Nefes alışınızı sakin tutun. Ardından parmaklarınızı yavaşça kaldırın. 5 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face_hand",
...

	{
		...
		NameEN:            "Chin Lift",
		NameTR:            "Çene Kaldırma",
		Category:          CategoryFace,
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Sit tall and tuck your chin slightly. Place the back of your hand or your knuckles firmly under your chin. Gently push upward with your hand while resisting downward with your chin — creating an isometric resistance exercise. Hold this gentle push-pull tension for 3 seconds, then fully release. This strengthens the submental muscles that prevent double chin formation. Keep your neck long throughout. Repeat 5 times.",
		InstructionsTR:    "Dik oturun ve çenenizi hafifçe içeri çekin. Elinizin arkasını ya da eklemlerinizi çenenizin altına sıkıca yerleştirin. Elinizle yukarı doğru nazikçe iterken çenenizle aşağıya doğru direnç uygulayın — izometrik bir direnç egzersizi oluşturarak. Bu nazik it-çek gerilimini 3 saniye tutun, ardından tamamen bırakın. Bu, çift çene oluşumunu önleyen submental kasları güçlendirir. Boyunca boynunuzu uzun tutun. 5 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face_hand",
...

	{
		...
		NameEN:            "Lip Press",
		NameTR:            "Dudak Baskılama",
		Category:          CategoryFace,
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Place your index and middle fingers horizontally across your closed lips — one finger on the upper lip, one on the lower. Gently press your lips outward against your fingers while keeping them sealed, creating a light resistance. Hold this pressing tension for 2 seconds, then completely relax. This tones the lip muscles and helps define the lip border. Repeat 5 times.",
		InstructionsTR:    "İşaret ve orta parmağınızı yatay olarak kapalı dudaklarınızın üzerine koyun — bir parmak üst dudakta, bir parmak alt dudakta. Dudaklarınızı hafif bir direnç oluşturarak parmaklarınıza karşı dışa doğru bastırın, kapalı tutarken. Bu bastırma gerilimini 2 saniye tutun, ardından tamamen gevşeyin. Bu hareket dudak kaslarını tonlar ve dudak sınırını belirginleştirmeye yardımcı olur. 5 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face_hand",
...

	{
		...
		NameEN:            "Brow Smoothing",
		NameTR:            "Kaş Arası Düzleştirme",
		Category:          CategoryFace,
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Place the index and middle fingers of both hands together at the glabella — the smooth area between your eyebrows. Gently press the skin flat and then slide your fingers outward (toward each temple) in a smoothing motion, like ironing out wrinkles. Pause at the end of the stroke with light pressure held for 2.5 seconds. This reduces frown lines and relieves forehead tension. Repeat 5 times.",
		InstructionsTR:    "Her iki elinizin işaret ve orta parmaklarını glabella'da — kaşlarınızın arasındaki düz alanda — bir araya getirin. Deriyi nazikçe düzleyin ve ardından parmaklarınızı dışarıya doğru (her şakağa doğru) kaydırın, kırışıklıkları ütülüyormuşsunuz gibi. Hafif baskı tutarak hareketin sonunda 2.5 saniye durun. Bu, kaş arası çizgileri azaltır ve alın gerginliğini giderir. 5 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face_hand",
...

	{
		...
		NameTR:            "Boyun Yan Germe",
		Category:          CategoryFace,
		Difficulty:        1,
		TargetArea:        "face",
		InstructionsEN:    "Sit upright. Place the palm of your right hand firmly against the right side of your neck and jaw area. Now gently tilt your head to the LEFT while keeping your hand in place — feel the stretch along the right side of your neck. Hold for 3 seconds. Return head to center and release. This stretches the sternocleidomastoid and scalene muscles that accumulate stress. Switch sides each rep. Repeat 5 times per side.",
		InstructionsTR:    "Dik oturun. Sağ elinizin avucunu boyununuzun ve çene bölgenizin sağ tarafına sıkıca yerleştirin. Şimdi elinizi yerinde tutarken başınızı hafifçe SOLA doğru eğin — boynunuzun sağ tarafında germeyi hissedin. 3 saniye tutun. Başı merkeze döndürün ve bırakın. Bu, stres biriktiren sternokleidomastoid ve skalen kasları gerer. Her tekrarda tarafı değiştirin. Her taraf için 5 kez tekrarlayın.",
...

	{
		...
		NameEN:            "Cheek Lift",
		NameTR:            "Yanak Kaldırma",
		Category:          CategoryFace,
		Difficulty:        2,
		TargetArea:        "face",
		InstructionsEN:    "Place the tips of your index, middle, and ring fingers flat on your left cheek — just below your eye and above your jaw. Gently push the cheek tissue UPWARD toward your cheekbone, as if lifting the cheek. Hold the upward pressure firmly for 2.5 seconds, then slowly release. This counters cheek sagging and tones the zygomaticus major. Keep your fingers still while holding. Repeat 5 times.",
		InstructionsTR:    "İşaret, orta ve yüzük parmağınızın uçlarını sol yanağınıza düz olarak — gözünüzün hemen altına ve çenenizin üstüne — yerleştirin. Yanak dokusunu nazikçe YUKARI doğru elmacık kemiğine doğru itin, yanağı kaldırıyormuşsunuz gibi. Yukarı baskıyı 2.5 saniye sıkıca tutun, ardından yavaşça bırakın. Bu, yanak sarkmalarını önler ve zygomaticus major'u tonlar. Tutarken parmaklarınızı sabit tutun. 5 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face_hand",
...

	{
		...
		NameEN:            "Jaw Side Release",
		NameTR:            "Çene Yan Gevşetme",
		Category:          CategoryFace,
		Difficulty:        2,
		TargetArea:        "face",
		InstructionsEN:    "Place your RIGHT hand's fingers gently against the RIGHT side of your chin and lower jaw. Now slowly slide your jaw to the RIGHT — as if pushing it rightward — against the gentle resistance of your hand. Hold the slid position for 2.5 seconds, then return your jaw to center and release your hand. This mobilizes the temporomandibular joint and relieves jaw tension. Do not force the movement — stay within a pain-free range. Repeat 5 times.",
		InstructionsTR:    "SAĞ elinizin parmaklarını çenenizin ve alt çenenizin SAĞ tarafına nazikçe yerleştirin. Şimdi çenenizi elinizin hafif direncine karşı SAĞA doğru — sağa itiyormuşsunuz gibi — yavaşça kaydırın. Kaydırılmış pozisyonu 2.5 saniye tutun, ardından çenenizi merkeze döndürün ve elinizi bırakın. Bu, temporomandibular eklemi mobilize eder ve çene gerginliğini giderir. Hareketi zorlamayın — ağrısız bir aralıkta kalın. 5 kez tekrarlayın.",
		Contraindications: []string{"jaw_injury"},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face_hand",
...

	{
		...
		NameEN:            "Brow Lift with Eye Open",
		NameTR:            "Kaş Kaldırarak Göz Açma",
		Category:          CategoryFace,
		Difficulty:        2,
		TargetArea:        "face",
		InstructionsEN:    "Place the palm of one hand firmly across your forehead, covering from your brow line up. Press gently upward and hold the forehead skin. Now, while resisting with your palm, open your eyes as wide as possible — as if surprised. This isometric combination lifts the brow area and strengthens the frontalis muscle while preventing compensatory forehead wrinkles. Hold both the palm pressure and wide eyes for 2 seconds, then release everything. Repeat 5 times.",
		InstructionsTR:    "Bir elinizin avucunu kaş hattından yukarıya kadar alnınıza sıkıca yerleştirin. Hafifçe yukarı bastırın ve alın derisini tutun. Şimdi avucunuzla direnerek gözlerinizi mümkün olduğunca geniş açın — şaşırmış gibi. Bu izometrik kombinasyon kaş bölgesini kaldırır ve aynı zamanda telafi edici alın kırışıklıklarını önlerken frontalis kasını güçlendirir. Avuç baskısını ve geniş gözleri 2 saniye boyunca tutun, ardından her şeyi bırakın. 5 kez tekrarlayın.",
		Contraindications: []string{},
		LandmarkRules:     []LandmarkRule{},
		IsAnalyzable:      true,
		AnalysisKind:      "face_hand",
